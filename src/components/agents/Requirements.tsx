...
export default function Requirements() {
  ...
  return (
    <section id="requirements" className="py-24" style={{ background: 'var(--bg-muted)' }}>
          ...
          <div className="space-y-8">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-[#FFFFFF]">Are you the next </span>
            ...
            <div className="space-y-4">
              <h3 className="text-[#FFFFFF] font-semibold">We look for</h3>
              {requirements.map((req) => (
                <div key={req} className="flex items-start gap-3 py-3 border-b border-white/10">
                  ...
                  <span className="text-[#8B92A5]">{req}</span>
                </div>
              ))}
            </div>
          </div>
