          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-[#0C0227]">Intelligent</span>
                <br />
                <span className="gradient-text">Customer</span>
                <br />
                <span className="text-[#0C0227]">Operations</span>
              </h1>
            </div>

            <p className="text-lg md:text-xl text-[#6b687a] max-w-xl leading-relaxed">
          ...
          <div className="relative lg:pl-8 animate-fade-in-up delay-200">
            <div className="grid grid-cols-2 gap-4">
              <div className="card-light p-6 space-y-3 hover:shadow-xl transition-all">
                ...
                <h3 className="text-[#0C0227] font-semibold">Say goodbye to shrinkage</h3>
                <p className="text-sm text-[#6b687a]">Cover any channel at any time with the best global agents</p>
              </div>
              ...
              <div className="card-light p-6 space-y-3 hover:shadow-xl transition-all">
                ...
                <h3 className="text-[#0C0227] font-semibold">Built-in surge capacity</h3>
                <p className="text-sm text-[#6b687a]">Ramp up coverage in real-time for surges and seasonality</p>
              </div>
              ...
              <div className="card-light p-6 space-y-3 hover:shadow-xl transition-all">
                ...
                <h3 className="text-[#0C0227] font-semibold">Automated workforce ops</h3>
                <p className="text-sm text-[#6b687a]">Define ideal agents and upload forecasts, the platform does the rest</p>
              </div>
              ...
              <div className="card-light p-6 space-y-3 hover:shadow-xl transition-all">
                ...
                <h3 className="text-[#0C0227] font-semibold">Cut costs by 25-55%</h3>
                <p className="text-sm text-[#6b687a]">Only pay for productive hours and save on management overhead</p>
              </div>
            </div>
