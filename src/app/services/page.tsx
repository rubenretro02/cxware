    ...
    <main className="min-h-screen">
      ...
      <section className="relative pt-28 pb-20 overflow-hidden bg-[var(--bg)]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            <span className="text-[var(--fg)]">Our </span>
      ...
      <section className="py-20 bg-[var(--bg-elev-1)]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--fg)] mb-12">
            ...
            {solutions.map((service) => (
              <Link key={service.slug} href={`/services/${service.slug}`} className="block h-full">
                <div className="card-light p-8 h-full flex flex-col">
                  <h3 className="text-xl font-bold text-[var(--fg)] mb-3">{service.title}</h3>
                  <p className="text-[var(--fg-muted)] mb-4 flex-1 leading-relaxed">{service.heroSubtitle}</p>
      ...
      {/* CTA */}
      <section className="py-24 bg-[var(--bg-elev-1)]">
        <div className="max-w-7xl mx-auto px-6">
